...
class Ui_Serial(object):
    def setupUi(self, Serial):
        ...
        self.gridLayout.addWidget(self.Serial_Line, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.Baudrate_Box, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.Address_Box, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.Buttons, 6, 0, 1, 1)
    ...
    def retranslateUi(self, Serial):
        Serial.setWindowTitle(QCoreApplication.translate("Serial", u"Dialog", None))
