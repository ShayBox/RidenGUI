...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuBar.setGeometry(QRect(0, 0, 680, 30))
        ...
        self.menuAbout.addAction(self.actionSettings)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuAbout.setTitle(QCoreApplication.translate("MainWindow", u"Edit", None))
